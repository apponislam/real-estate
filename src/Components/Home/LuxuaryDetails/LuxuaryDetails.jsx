    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="py-10 md:py-20 mx-4 md:mx-4 xl:mx-0">
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 xl:gap-12 mx-3 md:mx-0">
                    <div data-aos="fade-right">
                        <img src={image} className="w-full object-cover h-full" />
                    </div>
                    <div data-aos="fade-left">
                        <p className="font-semibold mb-3 animate__animated animate__bounceIn">Name: {estate_title}</p>
                        <div className="flex items-center py-4 mb-4 text-green-600 border-y">
                            <div className="text-2xl mr-3">
                                <GiVillage />
                            </div>
                            <p className="font-bold text-xl animate__animated animate__bounceIn">{segment_name}</p>
                        </div>
                        <h5 className="font-medium worksans mb-6 animate__animated animate__bounceIn">
                        ...
                        <div className="flex items-center mb-3 animate__animated animate__bounceIn">
